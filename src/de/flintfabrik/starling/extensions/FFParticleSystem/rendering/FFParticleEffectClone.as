...
package de.flintfabrik.starling.extensions.FFParticleSystem.rendering
{
	 ...
	 */
	public class FFParticleEffectClone extends FFParticleEffect
	{
		...
		/** Creates a new FFParticleEffectBeta instance. */
		public function FFParticleEffectClone()
		{
			_alpha = 1.0;
		}
		...
		override public function set alpha(value:Number):void  { _alpha = value; }
		...
		{
			return FFParticleEffectClone.buffersCreated;
		}
		...
		public static function createBuffers(bufferSize:uint = 0, numberOfBuffers:uint = 0):void
		{
			...
			FFParticleSystem.registerEffect(FFParticleEffectClone);
		}
		...
		public static function disposeBuffers():void
		{
			...
			$bufferSize = 0;
			FFParticleSystem.unregisterEffect(FFParticleEffectClone);
		}
